...
export default function SocialLinkPrimary({
  ...
  return (
    <span className="inline-block w-full relative">
      ...
      <div
        className="h-full w-full bg-slate-400 dark:text-slate-300 rounded-sm dark:bg-slate-800 transition dark:peer-hover:bg-slate-900 dark:peer-focus:bg-slate-900 dark:peer-active:bg-slate-900 top-0 left-0 z-0 absolute peer-hover:translate-y-1 peer-focus:translate-y-1 duration-300 peer-hover:translate-x-1 peer-focus:translate-x-1 peer-active:translate-x-2 peer-active:translate-y-2"
        aria-hidden="true"
        role="presentation"
      ></div>
